...
router.get('/profile', requireAdminAuth, asyncHandler(async (req, res) => {
  return res.json({
    success: true,
...
router.get('/', requireAdminAuth, requireSuperAdmin, asyncHandler(async (req, res) => {
...
router.get('/:id', requireAdminAuth, asyncHandler(async (req, res) => {
...
router.post('/', requireAdminAuth, requireSuperAdmin, asyncHandler(async (req, res) => {
...
router.put('/:id', requireAdminAuth, asyncHandler(async (req, res) => {
...
router.delete('/:id', requireAdminAuth, requireSuperAdmin, asyncHandler(async (req, res) => {
